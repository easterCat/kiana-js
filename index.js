...
function imageDownload(id, filename) {
 ...
 * @param place 保留几位小数
 */
function formatMoney(money, place) {
    money = String(money);
...
var index = _Object$assign({}, arr, func, obj, { getCookie: getCookie }, { removeCookie: removeCookie }, { setCookie: setCookie }, time, browser, mobile, { getLocal: getLocal }, { initLocal: initLocal }, { setLocal: setLocal }, { getSession: getSession }, { initSession: initSession }, { setSession: setSession }, date, { fileDownload: fileDownload }, { resetElement: resetElement }, { copyText: copyText }, { imageDownload: imageDownload }, { formatMoney: formatMoney });
